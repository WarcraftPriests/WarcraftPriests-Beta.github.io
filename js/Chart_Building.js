...
WCP_Chart.prototype.updateStackedBarChart = function(simsBtn, fightStyle, talentChoice, covenantType) {
  ...
  console.log(simsBtn, fightStyle, talentChoice);
  console.log(baseurl + "/" + simsBtn + "/results/Results_" + fightStyle +  "_" + talentChoice + ".json");
  ...
  jQuery.getJSON(baseurl + "/" + simsBtn + "/results/Results_" + fightStyle +  "_" + talentChoice + covenantPath +  ".json", function(data) {
    ...
    for(currStep of steps) {
      let maxStep = data["simulated_steps"][data["simulated_steps"].length];
      let stepDpsValues = [];
...
WCP_Chart.prototype.updateSingleBarChart = function(simsBtn, fightStyle, talentChoice, covenantType) {
  ...
  let chartName = fullTalents + " - " + fullSimType + " - " + fightStyle;
  console.log(baseurl + "/" + simsBtn + "/results/Results_" + fightStyle +  "_" + talentChoice + covenantPath +  ".json");
  jQuery.getJSON(baseurl + "/" + simsBtn + "/results/Results_" + fightStyle +  "_" + talentChoice + covenantPath +  ".json", function(data) {
...
function read_config(cfgfile){
  jQuery.get({url: cfgfile, dataType: "text"})
    .done(function (data) {
      ...
      console.log(titles);
      console.log(src);
      console.log(fightStyles);
      console.log(simType); // type
      console.log(talentBtns);      
